...
// -- Package metadata
export { ONI_CORE_VERSION } from "./version.js";
...
export type {
  ...
  ExternalAgentDriver,
  ExternalAgentHostConfig,
  ExternalAgentRuntimeDefinition,
  ExternalAgentRuntimeSummary,
  ExternalAgentRuntimeRegistryHostOptions,
  ExternalAgentNodeConfig,
  ExternalSwarmAgentConfig,
  CliExternalAgentDriverConfig,
  CodexExecDriverOptions,
  ClaudeCodeDriverOptions,
  DefaultExternalAgentRuntimeRegistryOptions,
  ExternalAgentUnsafeOptionPolicy,
} from "./harness/index.js";
